...
Secondly, there is a cost associated with using the BlueVia Voice APIs. You can [add a cash balance to your account][Overview Add Balance] that will then provide you access to all of the features of the BlueVia Voice APIs. Charges will be made to access the following BlueVia voice functionality:
