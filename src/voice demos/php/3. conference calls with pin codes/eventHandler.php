									...
									\"commands\": [
										{
											\"getDigits\": {
												...
												\"timeout\": \"15\",
												\"retries\": \"2\",
												\"actionUrl\": \"http://http://<your domain>/<your path>/startConference.php?state=participant\"
											}
										},
										{
											\"speak\": {
    		...
    		default:
    			$response = "{
					\"commands\": [
						...
						{
							\"redirect\": {
								\"callbackUrl\": \"http://http://<your domain>/<your path>/PincodeConference.php?state=eventHandler\"
							}
						}
					]
				}";
